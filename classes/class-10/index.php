<?php
$title       = "Class 10 AI Tutor Hindi | Board Exam Preparation | CG Board CBSE | Shrutam SAAVI";
$description = "Class 10 Science, Maths, Hindi SAAVI ke saath. Complete syllabus. Board exam ready. NCERT exact chapter names. ₹199/month. Free 7 day trial.";
$canonical   = "https://shrutam.ai/classes/class-10/";
$schema      = json_encode([
  "@context" => "https://schema.org",
  "@graph"   => [
    [
      "@type"           => "Course",
      "name"            => "Class 10 — SAAVI AI Tutor",
      "description"     => "Class 10 Science aur Maths SAAVI ke saath. NCERT syllabus. CG Board aur CBSE. Hindi, Hinglish, English, Telugu, Marathi mein.",
      "provider"        => [
        "@type" => "Organization",
    ...
    [
      ...
      "itemListElement" => [
        ...
        ["@type" => "ListItem", "position" => 3, "name" => "Class 10","item" => "https://shrutam.ai/classes/class-10/"],
      ],
    ],
  ],
    ...
    <div class="container">
      ...
      <nav aria-label="Breadcrumb" class="mb-8">
        <ol class="flex flex-wrap items-center gap-2 text-sm" style="color: var(--text-muted);">
          ...
          <li aria-hidden="true">›</li>
          <li aria-current="page" style="color: var(--text-secondary);">Class 10</li>
        </ol>
      </nav>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h1 id="hero-heading" class="text-5xl font-heading font-bold mb-3 text-gradient">
            Class 10 — Board Exam Ke Liye SAAVI Ke Saath
          </h1>

          <p lang="hi" class="font-devanagari-heading text-2xl mb-5" style="color: var(--accent);">
            बोर्ड एग्ज़ाम की तैयारी अब आसान है।
          </p>

          <p class="text-lg mb-8" style="color: var(--text-body);">
            SAAVI didi tumhare saath poora Class 10 ka syllabus cover karti hai — Science, Maths, Hindi.
  ...
  <section class="section section-dark" aria-labelledby="science-heading">
    <div class="container">
      <div class="text-center mb-10">
        ...
        <h2 id="science-heading" class="text-4xl font-heading font-bold mb-3">Class 10 Science — Poore Chapters</h2>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <?php
        $science_chapters = [
          [1,  "Chemical Reactions and Equations",        "Rasayanik Pratikriyaen — daily life mein chemistry"],
          [2,  "Acids, Bases and Salts",                  "Tezaab, Kshaar aur Namak — pH scale samjho"],
          [3,  "Metals and Non-metals",                   "Dhaatu aur Adhaatu — properties aur uses"],
          [4,  "Carbon and its Compounds",                "Carbon — life ka building block"],
          [5,  "Life Processes",                          "Jeevan Prakriyaen — breathing, nutrition, excretion"],
          [6,  "Control and Coordination",                "Niyantran aur Samanvay — nerves aur hormones"],
          [7,  "How do Organisms Reproduce?",             "Jaandar Kaise Reproduce Karte Hain?"],
          [8,  "Heredity",                                "Vanshagati — genes aur traits"],
          [9,  "Light — Reflection and Refraction",       "Prakash — reflection aur refraction"],
          [10, "The Human Eye and the Colourful World",   "Maanav Aankh aur Rangeen Duniya"],
          [11, "Electricity",                             "Vidyut — circuits, Ohm's law, power"],
          [12, "Magnetic Effects of Electric Current",    "Vidyut Dhara ke Chumbakiya Prabhav"],
          [13, "Our Environment",                         "Hamaara Paryavaran — ecosystems, waste"],
        ];
  ...
  <section class="section" aria-labelledby="maths-heading">
    <div class="container">
      <div class="text-center mb-10">
        ...
        <h2 id="maths-heading" class="text-4xl font-heading font-bold mb-3">Class 10 Maths — Poore Chapters</h2>
        <p class="text-lg" style="color: var(--text-secondary);">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <?php
        $maths_chapters = [
          [1,  "Real Numbers",                                  "Vastavik Sankhyaen — HCF, LCM, irrational numbers"],
          [2,  "Polynomials",                                   "Bahupad — zeroes aur division algorithm"],
          [3,  "Pair of Linear Equations in Two Variables",     "Do Charon mein Linear Samikaran"],
          [4,  "Quadratic Equations",                           "Dwidhaat Samikaran — factoring, formula"],
          [5,  "Arithmetic Progressions",                       "Samaantar Shreni — AP, nth term, sum"],
          [6,  "Triangles",                                     "Tribhuj — similarity aur Pythagoras"],
          [7,  "Coordinate Geometry",                           "Nirdeshaank Rekhaganit — distance, midpoint"],
          [8,  "Introduction to Trigonometry",                  "Trigonometry — sin, cos, tan"],
          [9,  "Some Applications of Trigonometry",             "Trigonometry ke Upyog — heights aur distances"],
          [10, "Circles",                                       "Vrittaen — tangent, chord, angle"],
          [11, "Areas Related to Circles",                      "Vrittaon se Sambandhit Kshetrafal"],
          [12, "Surface Areas and Volumes",                     "Pristh Kshetrafal aur Aayatan"],
          [13, "Statistics",                                    "Aankade — mean, median, mode"],
          [14, "Probability",                                   "Prayikta — likely outcomes"],
        ];
  ...
  <section class="section" aria-labelledby="cta-heading">
    <div class="container">
      <div class="max-w-2xl mx-auto text-center">
        <span class="badge badge-accent mb-4">🎯 Board Exam Ready</span>
        <h2 id="cta-heading" class="text-4xl font-heading font-bold mb-4">
          Class 10 Board Exam Crack Karo SAAVI Ke Saath
        </h2>
