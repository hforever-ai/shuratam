<?php
$title       = "Class 6 AI Tutor Hindi | NCERT Science Maths | CG Board CBSE | Shrutam SAAVI";
$description = "Class 6 Science, Maths SAAVI ke saath. Complete NCERT syllabus. CG Board aur CBSE. Hindi, Hinglish, English, Telugu, Marathi mein. ₹199/month. Free 7 day trial.";
$canonical   = "https://shrutam.ai/classes/class-6/";
$schema      = json_encode([
  "@context" => "https://schema.org",
  "@graph"   => [
    [
      "@type"           => "Course",
      "name"            => "Class 6 — SAAVI AI Tutor",
      "description"     => "Class 6 Science aur Maths SAAVI ke saath. NCERT syllabus. CG Board aur CBSE. Hindi, Hinglish, English, Telugu, Marathi mein.",
      "provider"        => [
        "@type" => "Organization",
    ...
    [
      ...
      "itemListElement" => [
        ...
        ["@type" => "ListItem", "position" => 3, "name" => "Class 6", "item" => "https://shrutam.ai/classes/class-6/"],
      ],
    ],
  ],
    ...
    <div class="container">
      ...
      <nav aria-label="Breadcrumb" class="mb-8">
        <ol class="flex flex-wrap items-center gap-2 text-sm" style="color: var(--text-muted);">
          ...
          <li aria-hidden="true">›</li>
          <li aria-current="page" style="color: var(--text-secondary);">Class 6</li>
        </ol>
      </nav>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <div class="flex flex-wrap gap-3 mb-6">
            <span class="badge badge-primary">📚 Class 6</span>
          ...
          <h1 id="hero-heading" class="text-5xl font-heading font-bold mb-3 text-gradient">
            Class 6 — Nai Duniya, SAAVI Ke Saath
          </h1>

          <p lang="hi" class="font-devanagari-heading text-2xl mb-5" style="color: var(--accent);">
            नई कक्षा, नया सफ़र — SAAVI दीदी के साथ।
          </p>

          <p class="text-lg mb-8" style="color: var(--text-body);">
            SAAVI didi tumhare saath poora Class 6 ka syllabus cover karti hai — Science aur Maths.
  ...
  <section class="section section-dark" aria-labelledby="science-heading">
    <div class="container">
      <div class="text-center mb-10">
        ...
        <h2 id="science-heading" class="text-4xl font-heading font-bold mb-3">Class 6 Science — Poore Chapters</h2>
        <p class="text-lg" style="color: var(--text-secondary);">
          NCERT exact chapter names. SAAVI har chapter ko real examples aur curiosity ke saath samjhati hai.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <?php
        $science_chapters = [
          [1,  "Food: Where Does it Come From?",                      "Khana kahan se aata hai — plants aur animals"],
          [2,  "Components of Food",                                   "Bhojan ke Ghatak — nutrients aur balanced diet"],
          [3,  "Fibre to Fabric",                                      "Reksha se Kapda — cotton, wool, silk"],
          [4,  "Sorting Materials into Groups",                        "Padarth ka Vargikaran — properties ke aadhar par"],
          [5,  "Separation of Substances",                             "Padarth ka Prithakaran — filtering, sieving"],
          [6,  "Changes Around Us",                                    "Hamare Aas-Paas Parivartan — reversible aur irreversible"],
          [7,  "Getting to Know Plants",                               "Paudhon ko Jaanein — roots, stem, leaves, flowers"],
          [8,  "Body Movements",                                       "Sharir ki Gatividiyan — joints aur skeleton"],
          [9,  "The Living Organisms and Their Surroundings",          "Jeev aur Unka Paryavaran — habitats aur adaptations"],
          [10, "Motion and Measurement of Distances",                  "Gati aur Dooriya — standard units"],
          [11, "Light Shadows and Reflections",                        "Prakash, Chhaayaen aur Pratibimb"],
          [12, "Electricity and Circuits",                             "Vidyut aur Parikuit — circuits aur switches"],
          [13, "Fun with Magnets",                                     "Chumbak ke Saath Khel — poles aur attraction"],
          [14, "Water",                                                "Paani — sources, uses, water cycle"],
          [15, "Air Around Us",                                        "Hamare Aas-Paas Hawa — composition aur importance"],
          [16, "Garbage In Garbage Out",                               "Kachra — recycling aur environment"],
        ];
  ...
  <section class="section" aria-labelledby="maths-heading">
    <div class="container">
      <div class="text-center mb-10">
        ...
        <h2 id="maths-heading" class="text-4xl font-heading font-bold mb-3">Class 6 Maths — Poore Chapters</h2>
        <p class="text-lg" style="color: var(--text-secondary);">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <?php
        $maths_chapters = [
          [1,  "Knowing Our Numbers",         "Sankhyaon ki Jankari — large numbers, place value"],
          [2,  "Whole Numbers",               "Poori Sankhyaen — number line aur properties"],
          [3,  "Playing with Numbers",        "Sankhyaon ke Saath Khel — factors, multiples, HCF, LCM"],
          [4,  "Basic Geometrical Ideas",     "Mool Rekhaganitiya Avdharanaen — points, lines, angles"],
          [5,  "Understanding Elementary Shapes", "Mool Aakaron ko Samjhein — 2D aur 3D shapes"],
          [6,  "Integers",                    "Poornanko — negative numbers aur number line"],
          [7,  "Fractions",                   "Bhinnaen — proper, improper, mixed fractions"],
          [8,  "Decimals",                    "Dashamlav — place value aur operations"],
          [9,  "Data Handling",               "Aankaron ka Prabandhan — tally, bar graph"],
          [10, "Mensuration",                 "Kshetramiti — perimeter aur area"],
          [11, "Algebra",                     "Beejganit — variables aur expressions"],
          [12, "Ratio and Proportion",        "Anupat aur Samanupat — comparing quantities"],
          [13, "Symmetry",                    "Samamiti — lines of symmetry"],
          [14, "Practical Geometry",          "Vyavaharik Rekhaganit — compass, ruler constructions"],
        ];
  ...
  <section class="section" aria-labelledby="cta-heading">
    <div class="container">
      <div class="max-w-2xl mx-auto text-center">
        <span class="badge badge-accent mb-4">🎯 Nai Shuruat</span>
        <h2 id="cta-heading" class="text-4xl font-heading font-bold mb-4">
          Class 6 Ki Nai Duniya SAAVI Ke Saath Explore Karo
        </h2>
