<?php
$title       = "Terms of Service | Shrutam — Kishyam AI Pvt Ltd";
      ...
      <div class="max-w-3xl mx-auto flex flex-col gap-10">
        ...
        <div class="card animate-on-scroll" style="border: 1px solid var(--border-subtle); background: var(--bg-surface);">
          ...
          <p class="text-sm" style="color: var(--text-body);">
            By accessing or using Shrutam (the "Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service. These terms constitute a legally binding agreement between you and Kishyam AI Pvt Ltd, operating under the brand Aarambha.
          </p>
        </div>
        ...
        <div class="card animate-on-scroll" style="border: 1px solid var(--border-subtle); background: var(--bg-surface);">
          ...
          <ul class="flex flex-col gap-2 text-sm" style="color: var(--text-body);">
            <li class="flex gap-2"><span style="color: var(--accent);">•</span> <span><strong style="color: var(--text-primary);">Educational Content:</strong> All lessons, explanations, quizzes, and audio generated by SAAVI are the intellectual property of Aarambha (Kishyam AI Pvt Ltd). You may use this content for personal, non-commercial learning only.</span></li>
        ...
        <div class="card animate-on-scroll" style="border: 1px solid var(--border-subtle); background: var(--bg-surface);">
          ...
          <p class="text-sm" style="color: var(--text-body);">
            Shrutam is an educational supplement, not a replacement for school instruction or professional advice. Kishyam AI Pvt Ltd is not liable for academic outcomes, exam results, or decisions made based on content provided by SAAVI. Our total liability to you for any claim arising under these terms shall not exceed the amount you paid in the 3 months preceding the claim.
          </p>
        </div>
        ...
        <div class="p-6 rounded-2xl text-center" style="background: var(--bg-elevated); border: 1px solid var(--border-default);">
          <p class="text-sm" style="color: var(--text-secondary);">
            These Terms of Service apply to Shrutam, a product of <strong style="color: var(--text-primary);">Kishyam AI Pvt Ltd</strong> (Aarambha), India.<br>
