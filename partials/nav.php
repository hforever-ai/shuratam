...
<header class="nav">
  <nav class="container flex items-center justify-between h-full" aria-label="Main navigation">
    <!-- Logo -->
    <a href="/" class="flex items-center gap-2 text-xl font-heading font-bold" style="color: var(--text-primary);">
    ...
    <div class="hidden lg:flex items-center gap-6 text-sm">
      ...
      <div class="relative group">
        ...
        <div class="absolute top-full left-0 mt-2 py-2 min-w-[160px] rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
          ...
          <a href="/classes/class-9/" class="block px-4 py-2 text-sm hover:bg-[var(--bg-elevated)]" style="color: var(--text-body);">Class 9</a>
          <a href="/classes/class-10/" class="block px-4 py-2 text-sm hover:bg-[var(--bg-elevated)]" style="color: var(--text-body);">Class 10</a>
        </div>
      </div>
      ...
      <div class="relative group">
        ...
        <div class="absolute top-full left-0 mt-2 py-2 min-w-[160px] rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
             style="background: var(--bg-surface); border: 1px solid var(--border-subtle); box-shadow: var(--shadow);">
          <a href="/boards/cg-board/" class="block px-4 py-2 text-sm hover:bg-[var(--bg-elevated)]" style="color: var(--text-body);">CG Board</a>
          <a href="/boards/cbse/" class="block px-4 py-2 text-sm hover:bg-[var(--bg-elevated)]" style="color: var(--text-body);">CBSE</a>
          <a href="/boards/mp-board/" class="block px-4 py-2 text-sm hover:bg-[var(--bg-elevated)]" style="color: var(--text-body);">MP Board (Soon)</a>
        </div>
      </div>
    ...
    <div class="flex items-center gap-3">
      ...
      <!-- CTA -->
      <a href="/waitlist/" class="btn btn-primary hidden sm:inline-flex">Join Waitlist Free →</a>
  ...
  <div id="mobile-menu" class="fixed inset-0 z-50 hidden" role="dialog" aria-modal="true" aria-label="Mobile navigation">
    ...
    <div class="absolute right-0 top-0 h-full w-[280px] p-6 flex flex-col gap-4 overflow-y-auto" style="background: var(--bg-surface);">
      ...
      <a href="/classes/class-9/" class="py-2 pl-4" style="color: var(--text-secondary);">Class 9</a>
      <a href="/classes/class-10/" class="py-2 pl-4" style="color: var(--text-secondary); border-bottom: 1px solid var(--border-subtle);">Class 10</a>
      <a href="/boards/cg-board/" class="py-2 pl-4" style="color: var(--text-secondary);">CG Board</a>
      <a href="/boards/cbse/" class="py-2 pl-4" style="color: var(--text-secondary);">CBSE</a>
      <a href="/boards/mp-board/" class="py-2 pl-4" style="color: var(--text-secondary); border-bottom: 1px solid var(--border-subtle);">MP Board (Soon)</a>
      <a href="/pricing/" class="py-3 text-lg font-heading" style="color: var(--text-body); border-bottom: 1px solid var(--border-subtle);">Pricing</a>
      <a href="/blog/" class="py-3 text-lg font-heading" style="color: var(--text-body); border-bottom: 1px solid var(--border-subtle);">Blog</a>
      <a href="/schools/" class="py-3 text-lg font-heading" style="color: var(--text-body); border-bottom: 1px solid var(--border-subtle);">For Schools</a>
      <a href="/waitlist/" class="btn btn-primary mt-4 justify-center">Join Waitlist Free →</a>
    </div>
  </div>
</header>
