<?php
$title       = "CG Board Class 10 Taiyaari 2026 — Complete Guide | SAAVI Shrutam";
$description = "CG Board Class 10 exam 2026 ki complete preparation guide. Science, Maths, Hindi — important topics, study schedule, SAAVI se practice.";
$canonical   = "https://shrutam.ai/blog/cg-board-class10-preparation/";
$schema      = json_encode([
  ...
  "@graph"   => [
    [
      ...
      "itemListElement" => [
        ...
        ["@type" => "ListItem", "position" => 3, "name" => "CG Board Class 10 Taiyaari 2026", "item" => "https://shrutam.ai/blog/cg-board-class10-preparation/"],
      ],
    ],
    [
      "@type"         => "Article",
      "headline"      => "CG Board Class 10 Taiyaari 2026 — Complete Guide",
      "description"   => "CG Board Class 10 exam 2026 ki complete preparation guide. Science, Maths, Hindi — important topics, study schedule, SAAVI se practice.",
      "url"           => "https://shrutam.ai/blog/cg-board-class10-preparation/",
    ...
    [
      ...
      "mainEntity" => [
        [
          "@type"          => "Question",
          "name"           => "CG Board Class 10 mein pass marks kitne chahiye?",
          "acceptedAnswer" => ["@type" => "Answer", "text" => "CGBSE Class 10 mein pass hone ke liye har subject mein minimum 33% marks chahiye. Theory (75 marks) mein alag se 33% aur Practical (25 marks) mein alag se 33% — dono mein alag alag pass karna zaroori hai. Overall aggregate se kaam nahi chalta."],
        ],
        [
          "@type"          => "Question",
          "name"           => "CG Board Class 10 exam 2026 kab hoga?",
          "acceptedAnswer" => ["@type" => "Answer", "text" => "CGBSE Class 10 board exams typically February-March mein hote hain. 2026 ke exact dates ke liye cgbse.nic.in official website check karo. Preparation ke liye abhi se start karo — 6 months pehle se daily 4-5 hours ki padhai best results deti hai."],
        ],
        [
          "@type"          => "Question",
          "name"           => "CG Board Science mein sabse important chapters kaun se hain?",
          "acceptedAnswer" => ["@type" => "Answer", "text" => "CG Board Class 10 Science mein sabse zyada marks wale chapters hain: Chemical Reactions and Equations (5-7 marks), Electricity (6-8 marks), Life Processes (5-6 marks), aur Light (5-6 marks). Har saal inme se zaroor questions aate hain. Equations aur diagrams pe focus karo."],
        ],
        [
          "@type"          => "Question",
          "name"           => "Maths mein quadratic equations zyada mushkil lagti hai — kya karein?",
          "acceptedAnswer" => ["@type" => "Answer", "text" => "Quadratic Equations sirf teen methods yaad karo: Factorization, Completing the Square, aur Quadratic Formula. Pehle easy practice questions karo (discriminant nikalna), phir word problems. Roz 5-10 questions practice karo. SAAVI ke saath adaptive practice karo — woh tumhari speed aur accuracy ke hisaab se questions adjust karti hai."],
        ],
        [
          "@type"          => "Question",
          "name"           => "CG Board aur CBSE mein kya difference hai preparation ke liye?",
          "acceptedAnswer" => ["@type" => "Answer", "text" => "CG Board ka syllabus CBSE se milta julta hai but exam pattern thoda alag hai. CG Board mein objective questions zyada hote hain aur practical marks separately count hote hain. CG Board ke previous year papers practice karo — wahi pattern samajhne ka best tarika hai. SAAVI ke paas CG Board specific content available hai."],
        ],
      ],
    ],
  ],
...
$og_image = 'https://shrutam.ai/assets/images/blog/cg-board-preparation.png';
    ...
    <div class="container">
      <div class="max-w-3xl mx-auto">
        ...
        <nav aria-label="Breadcrumb" class="text-sm mb-6" style="color: var(--text-muted);">
          ...
          <span class="mx-2">/</span>
          <span style="color: var(--text-secondary);">CG Board Class 10 Taiyaari</span>
        </nav>
        ...
        <div class="chalkboard mx-auto my-6">
            <img src="/assets/images/blog/cg-board-preparation.png" alt="CG Board Class 10 exam preparation — student studying" loading="lazy" class="w-full max-w-sm md:max-w-xl lg:max-w-2xl mx-auto my-8 rounded-xl">
          </div>
        ...
        <div class="card mb-8" style="border-left: 4px solid var(--accent); background: var(--bg-surface);">
          ...
          <ul class="text-sm space-y-1" style="color: var(--text-secondary);">
            ...
            <li>✅ SAAVI se kaise prepare karein</li>
          </ul>
        </div>
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-12">
          <h2 class="text-3xl font-heading font-bold mb-6" style="color: var(--text-primary);">
            📊 CGBSE Exam Pattern — Pehle Samjho, Phir Padho
          </h2>

          <p class="text-base mb-4" style="color: var(--text-body);">
            Chhattisgarh Board (CGBSE) Class 10 ka exam pattern bahut straightforward hai — agar ek baar clearly samajh lo toh anxiety automatically kam ho jaati hai. Har subject mein total 100 marks hote hain. Inme se <strong style="color: var(--primary-light);">75 marks Theory paper ke liye</strong> aur <strong style="color: var(--primary-light);">25 marks Practical / Internal Assessment ke liye</strong> hote hain.
          </p>
          ...
          <p class="text-base mb-4" style="color: var(--text-body);">
            Ek important baat yaad rakho — pass hone ke liye theory mein alag se 33% aur practical mein alag se 33% chahiye. Sirf overall aggregate se kaam nahi chalta. Isliye practical ko kabhi ignore mat karo. Practical mein lagbhag sab students ke ache marks aate hain — woh guaranteed marks hain agar tum sincere ho.
          </p>

          <p class="text-base" style="color: var(--text-body);">
            Theory paper mein objective questions (MCQ, fill in the blanks), short answer aur long answer questions hote hain. CG Board ka pattern CBSE se thoda alag hai — objective section mein jaldi jaldi marks secure ho jaate hain agar preparation solid ho.
          </p>
        </div>

        <!-- ─── Section 2: Study Schedule ────────────────── -->
        <div class="mb-12">
          <h2 class="text-3xl font-heading font-bold mb-6" style="color: var(--text-primary);">
            📅 6 Mahine Ka Study Schedule — Month by Month Plan
          </h2>

          <p class="text-base mb-6" style="color: var(--text-body);">
            Board exam February-March mein hota hai — matlab August se preparation shuru karo toh exactly 6 mahine milte hain. Yeh schedule Raipur, Bilaspur, Durg — sab jagah ke CG Board students ke liye kaam karta hai:
          </p>
        ...
        <!-- ─── Section 3: Subject-wise Topics ───────────── -->
        <div class="mb-12">
          <h2 class="text-3xl font-heading font-bold mb-6" style="color: var(--text-primary);">
            📚 Subject-wise Important Topics — Yahan Se Zyada Marks Aate Hain
          </h2>

          <p class="text-base mb-6" style="color: var(--text-body);">
            Sab topics equally important nahi hote. SAAVI didi ne analyze kiya hai CG Board ke past 5 saal ke papers — aur yeh raha shortlist:
          </p>

          <!-- Science -->
          <div class="card mb-6 animate-on-scroll" style="border-top: 3px solid var(--primary);">
            <div class="flex items-center gap-3 mb-4">
              <span class="text-2xl">🔬</span>
              <div class="font-heading font-bold text-xl" style="color: var(--primary-light);">Science</div>
            </div>
            <div class="space-y-3">
              <div>
          ...
          <!-- Maths -->
          <div class="card mb-6 animate-on-scroll" style="border-top: 3px solid var(--accent);">
            <div class="flex items-center gap-3 mb-4">
              <span class="text-2xl">📐</span>
              <div class="font-heading font-bold text-xl" style="color: var(--accent);">Mathematics</div>
            </div>
            <div class="space-y-3">
              <div>
          ...
          <!-- Hindi -->
          <div class="card mb-6 animate-on-scroll" style="border-top: 3px solid var(--warning);">
            <div class="flex items-center gap-3 mb-4">
              <span class="text-2xl">📖</span>
        ...
        <div class="mb-12">
          <h2 class="text-3xl font-heading font-bold mb-6" style="color: var(--text-primary);">
            ⚠️ Common Mistakes Jo CG Board Students Karte Hain
          </h2>

          <p class="text-base mb-6" style="color: var(--text-body);">
            Yeh galtiyan SAAVI didi ne hazaaron students ko karte dekha hai. Inhe time pe pakad lo — marks bachenge!
          </p>
        ...
        <div class="mb-12">
          <h2 class="text-3xl font-heading font-bold mb-6" style="color: var(--text-primary);">
            🤖 SAAVI Ke Saath CG Board Taiyaari — Kaise Kaam Karta Hai?
          </h2>

          <p class="text-base mb-6" style="color: var(--text-body);">
            SAAVI ek AI teacher didi hai jo <strong style="color: var(--accent);">Hindi aur Hinglish mein baat karti hai</strong> — bilkul tumhare school ki didi jaisi, bas 24x7 available aur kabhi bore nahi hoti! CG Board Class 10 ke liye SAAVI teen tarike se help karti hai:
          </p>
        ...
        <div class="space-y-4">
          ...
          <details class="card animate-on-scroll" style="cursor: pointer;">
            <summary class="font-heading font-bold text-lg" style="color: var(--text-primary); list-style: none; display: flex; justify-content: space-between; align-items: center;">
              CG Board Class 10 mein pass marks kitne chahiye?
          ...
          <details class="card animate-on-scroll" style="cursor: pointer;">
            <summary class="font-heading font-bold text-lg" style="color: var(--text-primary); list-style: none; display: flex; justify-content: space-between; align-items: center;">
              CG Board Class 10 exam 2026 kab hoga?
              <span style="color: var(--primary-light);">+</span>
            </summary>
            <div class="mt-4 pt-4" style="border-top: 1px solid var(--border-subtle);">
              <p class="text-sm" style="color: var(--text-body);">
          ...
          <details class="card animate-on-scroll" style="cursor: pointer;">
            <summary class="font-heading font-bold text-lg" style="color: var(--text-primary); list-style: none; display: flex; justify-content: space-between; align-items: center;">
              CG Board Science mein sabse important chapters kaun se hain?
              <span style="color: var(--primary-light);">+</span>
            </summary>
            <div class="mt-4 pt-4" style="border-top: 1px solid var(--border-subtle);">
              <p class="text-sm" style="color: var(--text-body);">
          ...
          <details class="card animate-on-scroll" style="cursor: pointer;">
            <summary class="font-heading font-bold text-lg" style="color: var(--text-primary); list-style: none; display: flex; justify-content: space-between; align-items: center;">
              Maths mein quadratic equations zyada mushkil lagti hai — kya karein?
              <span style="color: var(--primary-light);">+</span>
            </summary>
            <div class="mt-4 pt-4" style="border-top: 1px solid var(--border-subtle);">
              <p class="text-sm" style="color: var(--text-body);">
          ...
          <details class="card animate-on-scroll" style="cursor: pointer;">
            <summary class="font-heading font-bold text-lg" style="color: var(--text-primary); list-style: none; display: flex; justify-content: space-between; align-items: center;">
              CG Board aur CBSE mein kya difference hai preparation ke liye?
              <span style="color: var(--primary-light);">+</span>
            </summary>
            <div class="mt-4 pt-4" style="border-top: 1px solid var(--border-subtle);">
              <p class="text-sm" style="color: var(--text-body);">
