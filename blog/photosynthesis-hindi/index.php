    ...
    <div class="container">
      <div class="max-w-3xl mx-auto">
        ...
        <div class="chalkboard mx-auto my-6">
            <img src="/assets/images/blog/photosynthesis.png" alt="Photosynthesis — ped ka kitchen, sunlight se khana banata hai" loading="lazy" class="w-full max-w-sm md:max-w-xl lg:max-w-2xl mx-auto my-8 rounded-xl">
          </div>
