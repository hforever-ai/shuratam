      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="hidden md:flex items-center justify-center">
          <div class="chalkboard">
            <img src="/assets/images/features/mock-exams.png" alt="Mock exams — 4 difficulty levels from easy to board ready" loading="lazy" class="w-full max-w-[280px] rounded-xl">
          </div>
        </div>
      </div>
    </div>
