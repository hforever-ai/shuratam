<?php
$title       = "Exam Notes — SAAVI Ke Smart Notes | Shrutam";
$description = "Auto-generated summary, formulas, key points board exam format mein. Chapter-wise. Sab 5 languages mein available. SAAVI ke smart notes se exam mein ace karo.";
$canonical   = "https://shrutam.ai/features/exam-notes/";
$schema      = json_encode([
  ...
  "itemListElement" => [
    ...
    [
      ...
      "position" => 3,
      "name"     => "Exam Notes",
      "item"     => "https://shrutam.ai/features/exam-notes/",
    ],
  ],
...
<main id="main">
    ...
    <div class="container article-content">
      ...
      <nav aria-label="Breadcrumb" class="mb-8">
        <ol class="flex flex-wrap items-center gap-2 text-sm" style="color: var(--text-muted);">
          ...
          <li aria-hidden="true" style="color: var(--text-muted);">›</li>
          <li style="color: var(--text-secondary);">Exam Notes</li>
        </ol>
      </nav>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <div class="flex flex-wrap gap-3 mb-3">
            <span class="badge badge-accent">📋 Smart Notes</span>
          ...
          <h1 id="hero-heading" class="text-5xl font-heading font-bold mb-3 text-gradient">
            SAAVI Ke Smart Notes
          </h1>

          <p lang="hi" class="font-devanagari-heading text-2xl mb-5" style="color: var(--accent);">
            नोट्स बनाना SAAVI का काम।
          </p>

          <p class="text-lg mb-8" style="color: var(--text-body);">
            Exam ke liye notes banana time-consuming hai. SAAVI tumhare liye
            <strong style="color: var(--text-primary);">board exam format mein auto-generate karti hai</strong> —
            summaries, formulas, key points, mnemonics. Chapter-wise. Apni language mein.
            Tumhara kaam: sirf padho aur samjho.
          </p>
  ...
  <!-- ========================================================
       SECTION 2: WHAT'S IN THE NOTES
       ======================================================== -->
  <section class="section section-dark" aria-labelledby="content-heading">
    <div class="container article-content">
      <div class="text-center mb-12">
        <span class="badge badge-primary mb-4">Note Ka Structure</span>
        <h2 id="content-heading" class="text-4xl font-heading font-bold mb-4">
          SAAVI Notes Mein Kya Hota Hai?
        </h2>
        <p class="text-lg max-w-2xl mx-auto" style="color: var(--text-secondary);">
          Sirf theory nahi — board exam ke liye complete package.
        </p>
      </div>
  ...
  <section class="section" aria-labelledby="related-heading">
    <div class="container article-content">
      <div class="text-center mb-10">
        <h2 id="related-heading" class="text-3xl font-heading font-bold mb-3">Notes Ke Baad Yeh Bhi Karo</h2>
        <p class="text-lg" style="color: var(--text-secondary);">Notes padh liye — ab practice karo.</p>
      </div>
    ...
    <div class="container article-content">
      <div class="max-w-2xl mx-auto text-center">
        ...
        <h2 id="cta-heading" class="text-4xl font-heading font-bold mb-4">
          Smart Notes Se Smart Padhai
        </h2>
        <p lang="hi" class="font-devanagari text-xl mb-4" style="color: var(--accent);">
          नोट्स SAAVI बनाएगी — तुम बस पढ़ो।
        </p>
        <p class="text-lg mb-8" style="color: var(--text-secondary);">
          Waitlist join karo — launch pe har chapter ke smart notes ready milenge apni language mein. Free.
        </p>
