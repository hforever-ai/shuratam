      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="hidden md:flex items-center justify-center">
          <div class="chalkboard">
            <img src="/assets/images/features/mother-tongue.png" alt="Mother tongue learning — Hindi, Telugu, Marathi, English" loading="lazy" class="w-full max-w-[280px] rounded-xl">
          </div>
        </div>
      </div>
    </div>
