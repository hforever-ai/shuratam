      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div class="chalkboard mx-auto my-6">
            <img src="/assets/images/features/mother-tongue.png" alt="Mother tongue learning — Hindi, Telugu, Marathi, English" loading="lazy" class="w-full max-w-[240px] md:max-w-sm lg:max-w-md mx-auto my-6 rounded-xl">
          </div>
